export default function WhatsAppWidget() {
  return (
    <div className="fixed bottom-6 left-6 z-50 hidden lg:flex flex-col gap-3">
      <a href="tel:+201034442613" className="w-12 h-12 bg-primary rounded-full flex items-center justify-center shadow-xl hover:scale-110 transition-transform">
      ...
      <a href="https://wa.me/201034442613" target="_blank" rel="noopener noreferrer" className="w-12 h-12 bg-green-500 rounded-full flex items-center justify-center shadow-xl hover:scale-110 transition-transform">
